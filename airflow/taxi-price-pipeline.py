...
with DAG(dag_id='taxi-price-pipeline',
    ...
    preprocess = SparkSubmitOperator(
      application="/Users/yello-ow/taxi/airflow/preprocess.py", 
      task_id="preprocess", 
      conn_id="spark_local"
  )
    ...
    tune_hyperparameter = SparkSubmitOperator(
        application="/Users/yello-ow/taxi/airflow/tune_hyperparameter.py",
    ...
    train_model = SparkSubmitOperator(
        application="/Users/yello-ow/taxi/airflow/train_model.py",
        task_id='train_model',
        conn_id='spark_local'
    )
